...
QT_MOC_LITERAL(3, 18, 21) // "on_buttonBox_accepted"
    ...
    "deleteTable\0done\0\0on_buttonBox_accepted"
};
...
void deleteTable::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        deleteTable *_t = static_cast<deleteTable *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (deleteTable::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&deleteTable::done)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject deleteTable::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_deleteTable.data,
      qt_meta_data_deleteTable,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *deleteTable::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_deleteTable.stringdata0))
        return static_cast<void*>(const_cast< deleteTable*>(this));
